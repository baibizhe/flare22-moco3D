...
from models.unet3d.buildingblocks import DoubleConv, ExtResNetBlock, create_encoders, \
    create_decoders
from models.unet3d.utils import number_of_features_per_level, get_class
...
class ResidualUNet3D(Abstract3DUNet):
    ...
    def __init__(self, in_channels, num_classes, final_sigmoid=True, f_maps=64, layer_order='gcr',
